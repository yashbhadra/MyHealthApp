...
public class DeleteHealthRecordController {
	...
	public DeleteHealthRecordController(Stage parentStage, Model model) {
	...
	public void initialize() {
		...
		table.setOnMouseClicked((MouseEvent m)->{
			...
			try {
				FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/ConfirmDeleteHealthRecordView.fxml"));
				
				// Customize controller instance
				System.out.println(selected.getId());
				ConfirmDeleteHealthRecordController confirmDeleteRecordController =  new ConfirmDeleteHealthRecordController(stage, model,selected);

				loader.setController(confirmDeleteRecordController);
				VBox root = loader.load();
				
				confirmDeleteRecordController.showStage(root);
